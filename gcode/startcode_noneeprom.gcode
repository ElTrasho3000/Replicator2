...
G92 X285 Y150 Z0 A0 B0; set position
M131 X Y Z A B; store position in EEPROM
M132 X Y Z A B; load position from EEPROM
M114; report current position (not necessary but good for debugging)
